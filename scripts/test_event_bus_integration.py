...
async def test_event_bus_integration():
    ...
    print("\n" + "=" * 60)
    success = (
        EventType.SYSTEM_STARTUP in event_types_received
        and EventType.SYSTEM_READY in event_types_received
        and EventType.USER_INPUT in event_types_received
        and EventType.SYSTEM_SHUTDOWN in event_types_received
        and stats["events_failed"] == 0
    )
