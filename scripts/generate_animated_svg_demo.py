...
SVG_ANIMATED_TEMPLATE = """<svg viewBox="0 0 1400 900" xmlns="http://www.w3.org/2000/svg">
  ...
  <!-- User input prompt with blinking cursor -->
  <text class="text-cyan" x="30" y="570" style="animation: fadeIn 1s 9s forwards; opacity: 0;">╭─ [10:31:20]</text>
  <text class="text-yellow" x="150" y="570" style="animation: fadeIn 1s 9s forwards; opacity: 0;">👤 YOU</text>
  <text class="text-white" x="30" y="590" style="animation: fadeIn 1s 9s forwards; opacity: 0;">│</text>
  
  <!-- Blinking cursor at user input position -->
  <rect class="cursor text-bright-white" x="45" y="578" width="8" height="15" style="animation-delay: 9.5s;"/>
