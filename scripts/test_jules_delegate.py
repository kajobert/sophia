...
async def test_delegate_task():
    ...
    try:
        ...
        if session:
            ...
            print("   Prompt: Create test.txt with Hello message")
            ...
            monitor_status = jules_monitor.check_session_status(context, session_id)

            if monitor_status:
                print("✅ Monitor tracking session")
            ...
            print("=" * 60)
            print("\n📋 Summary:")
            print("  • Jules API: ✅ Working")
            print("  • Session Creation: ✅ Working")
            print("  • Monitor Plugin: ✅ Working")
            ...
            print("❌ Session creation failed: No session returned")
            return False
