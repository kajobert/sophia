...
MAIN_MODELS = [
    ...
    "openrouter/meta-llama/llama-3-8b-instruct",  # noqa: E501
    "openrouter/mistralai/mistral-7b-instruct-v0.3",  # noqa: E501
    "openrouter/anthropic/claude-3-haiku",
    "openrouter/google/gemini-2.0-flash-001",
    "openrouter/microsoft/phi-3-mini-128k-instruct",  # noqa: E501
    "openrouter/openai/gpt-4o-mini",
    "openrouter/cohere/command-r-08-2024",
    "openrouter/mistralai/mixtral-8x7b-instruct",
    "openrouter/deepseek/deepseek-chat",
    "openrouter/qwen/qwen-plus",
    "openrouter/meta-llama/llama-3.1-70b-instruct",  # noqa: E501
    "openrouter/mistralai/codestral-2508",
    "openrouter/google/gemini-2.5-flash",
    "openrouter/x-ai/grok-3-mini",
    "openrouter/nousresearch/hermes-2-pro-llama-3-8b",  # noqa: E501
...
**Goal:** Read the `README.md` file, summarize its content, and write the summary
to a new file named `docs/summary.md`.

Here is the plan:
1.  **tool_file_system.list_directory(path=".")** - to see the files in the
    current directory.
2.  **tool_file_system.read_file(filepath="README.md")** - to read the content of
    the README file.
3.  **tool_llm.execute(prompt="Summarize the following text: {file_content}")** -
    to summarize the content.
4.  **tool_file_system.write_file(filepath="docs/summary.md", content="{summary}")**
    - to write the summary to a new file.
5.  **tool_file_system.list_directory(path="docs/")** - to verify the new file
    was created.
6.  **tool_file_system.read_file(filepath="docs/summary.md")** - to verify the
...
def load_pricing_data() -> Dict[str, Dict[str, float]]:
    ...
    try:
        ...
        print(
            "Warning: Could not load pricing data from docs/openrouter_models.md. "
            f"Cost calculation may be inaccurate. Error: {e}"
        )
    return pricing_data
...
async def main():
    ...
    for i, model_name in enumerate(all_models):
        ...
        try:
            ...
            logger.error(
                "An error occurred while evaluating %s: %s",
                model_name,
                e,
                exc_info=True,
            )
        ...
        if i >= 2:  # After the first 3 models
            ...
            if projected_cost > 3.00:
                print(
                    "\\n*** BUDGET ALERT: Projected cost exceeds $3.00. "
...
if __name__ == "__main__":
    ...
    if "OPENROUTER_API_KEY" not in os.environ:
        ...
        if "OPENROUTER_API_KEY" not in os.environ:
            # fmt: off
            print("Error: OPENROUTER_API_KEY is not set. Please create a .env file or set the environment variable.")  # noqa: E501
            # fmt: on
            sys.exit(1)
