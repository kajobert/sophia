...
from textual.widgets import Header, Footer, Static, Input, RichLog, DataTable, ProgressBar
...
class SophiaHolographicUI(App):
    ...
    def on_mount(self) -> None:
        ...
        chat_log.write("[bold cyan]═══════════════════════════════════════════════[/bold cyan]")
        chat_log.write("")
        chat_log.add_message("assistant", "Greetings. I am SOPHIA, your autonomous AI companion. How may I assist you today?")
