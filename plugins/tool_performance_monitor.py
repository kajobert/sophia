...
class GetMetricsRequest(BaseModel):
    ...
    time_period: str = Field(default="24h", pattern="^(1h|24h|7d|30d)$", description="Time period for metrics")
...
class ToolPerformanceMonitor(BasePlugin):
                ...
                "function": {
                    ...
                    "parameters": {
                        ...
                        "properties": {
                            ...
                            "output_tokens": {"type": "integer", "description": "Output tokens generated"},
    ...
    def log_llm_call(
        ...
        try:
            ...
            context.logger.error(
                f"Invalid LLM call parameters: {e}",
    ...
    def log_tool_usage(
        ...
        try:
            ...
            context.logger.error(
                f"Invalid tool usage parameters: {e}",
                extra={"plugin_name": self.name}
            )
            raise
