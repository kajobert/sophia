...
### Fáze 15: Vylepšení Procesů a Kvality

**Cíl:** Zavádět nástroje a agenty, které zlepšují kvalitu, udržitelnost a transparentnost vývojového procesu.

- [x] **15.1. Implementace Reviewer Agenta:**
    -   Vytvořit nového agenta (`Reviewer Agent`) zodpovědného za kontrolu dokumentace.
    -   Agent ověřuje, že změny v kódu (`.py`) jsou vždy doprovázeny aktualizací `WORKLOG.md`.
    -   Aktualizovat `AGENTS.md` a další relevantní dokumentaci.