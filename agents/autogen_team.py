...
class SimplePhilosopher(Agent):
    def __init__(self):
        super().__init__(name="Philosopher", system_message="Analyzuj minulé události a generuj nové nápady.")
...
class SimpleArchitect(Agent):
    def __init__(self):
        super().__init__(name="Architect", system_message="Navrhuj nové strategie a architektury.")
    def generate_message(self, messages, context):
