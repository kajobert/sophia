...
class EventDrivenLoop:
    ...
    def _setup_event_handlers(self):
        ...
        logger.info(
            "Event-driven loop handlers registered",
    ...
    async def _handle_user_input(self, event: Event):
        ...
        logger.debug(
            f"USER_INPUT event received: {user_input}",
            extra={"plugin_name": "EventDrivenLoop"}
        )
    ...
    async def run(
        ...
        single_run_input: Optional[str] = None
    ):
        """
        ...
        logger.info(
            "Starting event-driven consciousness loop",
            extra={"plugin_name": "EventDrivenLoop"}
        )
    ...
    def stop(self):
        ...
        self.is_running = False
        logger.info(
            "Event-driven loop stop requested",
            extra={"plugin_name": "EventDrivenLoop"}
        )
