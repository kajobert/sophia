...
from core.orchestrator import Colors
...
class MCPClient:
    ...
    async def execute_tool(self, tool_name: str, args: list, verbose: bool = False) -> str:
        ...
        if verbose:
            print(f"{Colors.CYAN}INFO: Odesílám MCP požadavek na server '{server_name}':{Colors.ENDC}")
            print(f"{Colors.BLUE}{mcp_request}{Colors.ENDC}")
