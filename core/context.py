...
class SharedContext(BaseModel):
    ...
    current_plan: Optional[List[Dict[str, Any]]] = Field(
        default=None, description="The structured plan currently being executed."
    )
    step_history: List[Dict[str, Any]] = Field(
        default_factory=list,
        description="A log of all executed steps and their outcomes.",
    )
    last_step_output: Optional[Dict[str, Any]] = Field(
        default=None, description="The output from the last executed step."
    )
