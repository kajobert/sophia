...
pytest.skip("Testy EthosModule nelze robustně izolovat bez mockování paměti/memori.", allow_module_level=True)
from core.ethos_module import EthosModule, PlanState, propose_plan, critique_plan, revise_plan, approve_or_reject
