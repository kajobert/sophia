...
async def test_event_loop_single_run_mode(event_loop_instance, event_bus):
    ...
    # Create context
    context = SharedContext(session_id="test-123", current_state="INITIALIZING", logger=Mock())
...
async def test_event_loop_stop(event_loop_instance):
    ...
    context = SharedContext(session_id="test-123", current_state="RUNNING", logger=Mock())
