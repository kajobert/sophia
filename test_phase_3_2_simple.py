"""Simple test for Phase 3.2 Memory Consolidator"""
...
# Cleanup old (>7 days)
print("Creating 5 very old operations (>7 days)...")
for i in range(5):
...
deleted = asyncio.run(consolidator._cleanup_old_operations())
...
asyncio.run(consolidator._on_dream_trigger(trigger))
